...
public class MuzSnackbarContentLayout extends LinearLayout implements
        MuzBaseTransientBottomBar.ContentViewCallback {
    ...
    public MuzSnackbarContentLayout(Context context) {
        this(context, null);
    }

    public MuzSnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
